...
class ProviderConnectionsTests(unittest.TestCase):
    def setUp(self):
        ...
        for name, value in [('TOKEN_PATH', token), ('CONFIG_DIR', self.root), ('OPENROUTER_KEY', ''), ('PROVIDER_ACTIVITY', {}), ('TURN_ROUTES', {}), ('OPAQUE_HISTORY', bridge.OrderedDict()), ('READINESS', bridge._runtime_module.RouteReadiness())]:
