...
The current checks include twelve Swift tests and twenty-seven Python tests. Routing tests cover independent tasks, turn pinning, restart recovery, frozen legacy routing, native/custom tool history, and credential separation.
