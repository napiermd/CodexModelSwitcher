...
let package = Package(
    ...
    targets: [
        ...
        .testTarget(name: "HarborCoreTests", dependencies: ["HarborCore"], path: "Tests", exclude: ["test_context_audit.py", "test_request_metrics.py", "test_context_capacity.py", "test_chat_compat.py", "test_router_hardening.py", "test_gateway_maintenance.py", "test_maintenance_controller.py", "test_provider_restore.py", "test_azure_history.py", "test_bifrost_composed.py", "test_azure_error_budget.py", "test_azure_transport.py", "test_azure_handler_deadline.py", "test_bifrost_pilot.py", "test_bifrost_pressure.py", "test_azure_admission.py", "test_azure_handler_admission.py", "test_gateway_service.py", "test_gateway_runtime.py", "test_gateway_lifecycle.py", "test_stage_update.py", "test_azure_provider.py", "test_grok_adapter.py", "test_provider_usage.py", "test_baseten_images.py", "test_baseten_pacing.py", "test_task_repair.py", "test_task_repair_api.py", "test_harbor_team.py", "test_baseten_reasoning.py", "test_provider_connections.py", "__pycache__"])
    ])
