...
6. Poll authenticated status from Swift. Job registration and process health do not prove provider readiness. Existing provider synchronization continues through the bridge's authenticated API.
